...
public class Lead {
		...
		public static void main(String[] args) throws InterruptedException, IOException {
		    ...
		    driver.findElement(By.id("Leads_editView_fieldName_firstname")).sendKeys("raghu");
		    driver.findElement(By.id("Leads_editView_fieldName_lastname")).sendKeys("mirajgaonkar");
		    driver.findElement(By.id("Leads_editView_fieldName_phone")).sendKeys("7057205684");
		    driver.findElement(By.id("Leads_editView_fieldName_company")).sendKeys("ram internationals");
		    driver.findElement(By.id("Leads_editView_fieldName_mobile")).sendKeys("8007535491");
